...
<!-- image-id: FN-006-01 | path: images/fn-006/fn-006-01.png -->
> [此处应有：图 FN-006-01——UCP 供应商管理页面；框出“自动拉取官方模型”、刷新按钮和模型列表为空的位置]
...
<!-- image-id: FN-006-02 | path: images/fn-006/fn-006-02.png -->
> [此处应有：图 FN-006-02——VS Code Chat 返回 401 Unauthorized 的错误提示；框出状态码和请求供应商；隐藏请求 ID、Key 和账号]
...
<!-- image-id: FN-006-03 | path: images/fn-006/fn-006-03.png -->
> [此处应有：图 FN-006-03——同一会话中“Ask 模式只能聊天”与“Agent 模式出现工具动作”的对比图；框出模式选择器和工具调用记录]
...
<!-- image-id: FN-006-04 | path: images/fn-006/fn-006-04.png -->
> [此处应有：图 FN-006-04——429 或请求超时的错误提示，以及将思考强度从 Max 改为 High 的模型菜单；框出状态码和强度选项]
